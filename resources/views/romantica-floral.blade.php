...
.hero{
  ...
  background: linear-gradient(rgba(125,155,123,0.25),rgba(168,202,173,0.35)),
              ...
              */
              url('{{ $event->cover_photo_url ? asset('public/uploads/' . $event->cover_photo_url) : 'https://images.unsplash.com/photo-1519741497674-611481863552?w=1600' }}') center/cover fixed;
  color:var(--white);
  overflow:hidden;
